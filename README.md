...
This repository is at the Player 2 feasibility stage. Version `0.1.4` provides a diagnostic proxy that tests the engine paths needed before local or networked co-op can be implemented safely.
...
When updating, run `git pull`, restart or reload the mod, and confirm `Co-op Feasibility Probe v0.1.4` appears in its settings panel.
...
12. Reopen the mod settings and check **I can see the Player 2 avatar** only if the cyan-tinted native sprite was rendered correctly rather than the rectangular fallback.
...
```text
P2D1 V=0.1.4 H=P:900/880/860/860/2700 I=P:K:-/7/7/7/A- K=7/7/H0000/R0000/U7860/N1/S0 M=P:18/24/1 R=P:600/610/1/D900/H00 N=P:600/600/600/120/0/S600/F1/LOK C=P:4512/0/0/350/4/1/B11 T=P:1/1/3 S=P:17/6/860 G=OK:E1S1P1 Q=1/1/1/0 A=P:64/1 E=0
```
